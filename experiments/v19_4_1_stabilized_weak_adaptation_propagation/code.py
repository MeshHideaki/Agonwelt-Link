# Agonwelt-Link v19.4.1
# stabilized weak adaptation propagation
...
def update_ecology(nodes):
    ...
    for node in nodes:
        ...
        # localized residual persistence
        node.adaptation_trace += (
            instability_gap * 0.010
        )

        # divergence floor support
        ...
        # bounded diversity preservation

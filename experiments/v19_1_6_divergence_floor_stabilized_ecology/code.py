# Agonwelt-Link v19.1.6
# divergence floor stabilized ecology
...
def update_local_ecology(nodes):
    ...
    for node in nodes:
        ...
        # stronger ecological differentiation
        ...
        # stronger divergence floor stabilization
        if global_divergence < 0.22:

            if global_offset < 0.12:
